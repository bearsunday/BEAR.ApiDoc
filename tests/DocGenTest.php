...
class DocGenTest extends TestCase
{
    public function test__invoke()
    {
        ...
        $this->assertFileExists(__DIR__ . '/doc/api/schema/address.json');
        $this->assertStringContainsString('<h1>person', (string) file_get_contents(__DIR__ . '/doc/api/rels/person.html'));
        $this->assertStringContainsString(' "rel": "person"', (string) file_get_contents(__DIR__ . '/doc/api/rels/person.json'));
        $this->assertStringContainsString('$id": "http://example.com/schema/address.json', (string) file_get_contents(__DIR__ . '/doc/api/schema/address.json'));
    }
